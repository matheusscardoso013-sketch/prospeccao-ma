        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cnae = table.Column<string>(type: "text", nullable: false),
                    Uf = table.Column<string>(type: "text", nullable: false),
                    Municipio = table.Column<string>(type: "text", nullable: false),
                    CapitalSocial = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    Situacao = table.Column<string>(type: "text", nullable: false),
                    PorteEstimado = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LeadScores_Configuracoes_ConfiguracaoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeadScores_LeadId_ConfiguracaoId",
                table: "LeadScores",
                columns: new[] { "LeadId", "ConfiguracaoId" },
                unique: true);
        }
